...
PYTHON_ENV_NAME=venv_x86

/Users/jingai/homebrew/opt/python\@3.8/bin/pip3 install virtualenv

/Users/jingai/homebrew/bin/virtualenv -p python3 $PYTHON_ENV_NAME
